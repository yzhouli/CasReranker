# CasReranker: 基于多智能体协同工作流的级联重排序与多模态基准
...
| 组件 | 环境 | Python | 关键依赖 |
|---|---|---|---|
| CasReranker (LLM推理) | conda_env | 3.10 | vLLM, openai, numpy, tqdm |
| 单智能体LLM评估 | conda_env | 3.10 | openai, numpy, tqdm, pillow, opencv-python |
| GNN基线训练 | conda_env | 3.12 | PyTorch 2.7.0+cu128, PyTorch Geometric |
...
│   ├── CasReranker.py                 # 主工作流（多GPU并行、RAG记忆、自适应token）
